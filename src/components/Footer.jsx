...
import { FaLocationDot, FaPhone, FaEnvelope, FaTwitter, FaFacebookF, FaYoutube, FaLinkedinIn, FaChevronRight, FaInstagram } from 'react-icons/fa6'
...
export default function Footer() {
  ...
  const scrollTop = () => {
    try { window.scrollTo({ top: 0, left: 0, behavior: 'instant' in window ? 'instant' : 'auto' }) } catch (_) { window.scrollTo(0, 0) }
  }
  ...
  // Uygulamalarimiz - 5 hizmet gorseli, Projeler sayfasina yonlendirir
    ...
    <div className="container-fluid text-white footer mt-5 pt-5 px-0 wow fadeIn" style={{ backgroundColor: '#25acbf' }} data-wow-delay="0.1s">
      <div className="container py-5">
        <div className="row g-5">
          ...
          {/* 4 - Uygulamalarimiz (5 hizmet gorseli, Projeler sayfasina yonlendirir) */}
          <div className="col-lg-3 col-md-6">
